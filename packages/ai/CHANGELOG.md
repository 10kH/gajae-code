...
- Added the typed `local_snapshot_failure` assistant error kind so downstream retry policy can distinguish local event-snapshot failures from provider failures.
