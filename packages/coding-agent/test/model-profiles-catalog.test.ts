...
const expectedProfiles: Array<{
	...
	},
	{
		...
		requiredProviders: ["omlx"],
		mapping: {
			default: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/4bit:medium",
			executor: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/4bit:low",
			architect: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/4bit:high",
			planner: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/4bit:high",
			critic: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/4bit:medium",
		},
	},
	{
		...
		requiredProviders: ["omlx"],
		mapping: {
			default: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/6bit:medium",
			executor: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/6bit:low",
			architect: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/6bit:high",
			planner: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/6bit:high",
			critic: "omlx/PocketAiHub/Qwen3.8-27B-Abliterated-MLX/6bit:medium",
		},
	},
	{
		name: "opencodego",
